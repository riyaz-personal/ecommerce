...
|--------------------------------------------------
*/
import { apiDomain, addAddressMethod } from "../../../Api/helper";
...
class AddAddress extends Component {
  ...
  handleSubmit = async (e) => {
    ...
    if (formValid(errors)) {
      ...
      const requestUrl = apiDomain + addAddressMethod;
      ...
      const inputData = {
        ...
        data_arr: {
          customer_id,
          address_title: values.addressTitle,
          address: values.custAddress,
          landmark: values.custLandmark,
          area_name: values.custArea,
          city_name: values.custCity,
          state_name: values.custState,
          country_name: values.custCountry,
          pincode: values.custPincode,
        },
      };
